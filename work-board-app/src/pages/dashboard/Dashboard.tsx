...
const Dashboard = () => {
    const [ticketsByStatus, setTicketsByStatus] = React.useState<Type.ITicketByStatusEntry[] | null>(null);
                        ...
                        <Pie
                            data={{
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: ['rgb(100, 78, 130)', 'rgb(169 133 218)', 'rgb(226 213 244)', 'rgb(226 213 210)'],
                                }],
                            }
                        }
                        options={{
